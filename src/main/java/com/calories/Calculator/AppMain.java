...
import com.calories.Calculator.Dao.CustomerInfoDao;
import com.calories.Calculator.Dao.CustomerInfoDaoImpl;
import com.calories.Calculator.Entity.CustomerInfo;
import com.calories.Calculator.Service.CalculatorService;
...
public class AppMain {
	public static void main(String[] args) {
		...
		// for Update Entry
			...
			customerInfoDaoImpl.updateCustomer(customerInfo);
